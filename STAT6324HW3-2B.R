...
plotROC(test$is_canceled, probabs)
 ...
 # model 0
 # base model using variables that were identified by original researchers
 # note: base model works without one-hot encoding data for training and test sets
 #       requires a different training and test set without one-hot encoding in file 1
